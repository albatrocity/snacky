...
var analyzeEvent = new Event('analyze');

var AudioAnalyser = (function (_EventEmitter) {
  _inherits(AudioAnalyser, _EventEmitter);

  function AudioAnalyser(audioCtx, source) {
    _classCallCheck(this, AudioAnalyser);

    _get(Object.getPrototypeOf(AudioAnalyser.prototype), "constructor", this).call(this);
...
var an = new AudioAnalyser(audioCtx, source);
